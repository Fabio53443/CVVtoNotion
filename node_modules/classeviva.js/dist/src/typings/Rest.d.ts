...
export { ClassOptions, User, Headers, FetchOptions, FetchResponse, LoginResponse, AgendaFilter, TalkOptions, Overview, Card, ContentElement, TermsAgreementResponse, setTermsAgreementResponse, readOptions, TokenStatus, TicketResponse, checkDocument, absences, readNotice, Grade, calendarDay, resetPassword, AgendaNotes, readNote, Term, };
