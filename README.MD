...
2. Appunta la chive e l'id database (lo puoi recuperare dall'URL, copia dallo slash dopo il nome fino a ?: https://www.notion.so/nomeutente/`DBID`?v=dbb7e9f6a670470d8c1781c3e6fe3ee7, sarebbe `DBID`). Ti serviranno più tardi.
